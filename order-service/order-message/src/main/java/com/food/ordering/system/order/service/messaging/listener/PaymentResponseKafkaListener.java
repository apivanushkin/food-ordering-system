...
import com.food.ordering.system.kafka.model.PaymentResponseModel;
...
public class PaymentResponseKafkaListener implements KafkaConsumer<PaymentResponseModel> {
    ...
    private static final String PROCESSING_MESSAGE = "Processing payment response with status={} for order with id={}";
    ...
    public void receive(
            @Payload List<PaymentResponseModel> messages,
